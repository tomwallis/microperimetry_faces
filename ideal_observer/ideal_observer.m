...
nTrialsPerBlurLevel = 1000; % the number of trials per condition to have the observer do.
...
wNZ = [0.005 logspace(log10(.5),log10(5000),13)]; % the variance on the Gaussian pixel noise.
...
load('/Users/peterbex/Dropbox/Projects/AMD_Faces/clinical_faces_analysis/images/faceFiltStimuliOrderedViews.mat')
...
save('idealPerformance.mat','dataMat')